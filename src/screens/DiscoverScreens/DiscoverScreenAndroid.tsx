...
import PreviewDetailsAndroid from "../HomeScreens/PreviewDetailsAndroid";
    ...
    return (
        <AppSafeAreaView>
            ...
            <Modal
                ...
                <PreviewDetailsAndroid data={profileData} setModalVisible={setModalVisible}
...
export default DiscoverScreenAndroid;
