...
import { applogo, BottomLayer, dummyfemaleProfile, dummyMaleProfile, filterNewIcon, HeaderHomeBack } from "../helper/ImageAssets";
...
const NewHeaderAndroid = ({ style, onFilterPress, filterShow = true }: any) => {
    const userData = useSelector((state: any) => state.auth.userData);

    return (
        <ImageBackground source={HeaderHomeBack} resizeMode="stretch" style={[styles.bottomLayer, style]}>
            <View style={styles.container}>
                <FastImage source={applogo} resizeMode="contain" style={styles.headerLogo} />
