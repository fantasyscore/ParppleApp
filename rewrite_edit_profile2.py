...
# Inject Heights generation and main component
component_start = content.find('const EditProfileScreen = () => {')
component_end = content.find('export default EditProfileScreen;')
...
content = content[:component_start] + new_component.strip() + '\n' + content[component_end:]


# Replace the styles object completely
...
content = content[:styles_start] + new_styles.strip() + '\n'
